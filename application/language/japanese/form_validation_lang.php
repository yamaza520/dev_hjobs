...
$lang['greater_than']          = "%s 欄は %s より大きい値でなければいけません。";
$lang['greater_than_equal_to'] = "%s 欄は %s 以上の値でなければいけません。";
$lang['less_than']             = "%s 欄は %s より小さい値でなければいけません。";
$lang['less_than_equal_to']    = "%s 欄は %s 以下の値でなければいけません。";
$lang['decimal']               = "%s 欄は10進数のみです。";
...
$lang['phone']              = "%s 欄は、正しい電話番号を入力する必要があります。";
