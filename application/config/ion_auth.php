 ...
 */
$config['site_title']                 = "HOTELIER・Jobs";       // Site Title, example.com
$config['admin_email']                = "noreply@hotelierjobs.com"; // Admin Email, admin@example.com
$config['default_group']              = 'jobseeker';         // Default group, use name
 ...
 */
$config['email_activate'] = '../../email_templates/activate.tpl.php';
 ...
 */
$config['email_forgot_password'] = '../../email_templates/forgot_password.tpl.php';
