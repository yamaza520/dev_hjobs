        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <?php echo anchor($base_path . 'news/setup', 'お知らせ登録', array('class' => 'btn btn-success btn-flat')); ?>
                </div>
                <div class="box-body">
                        ...
                        <?php if (count($result)): ?>
                            <?php foreach ($result as $row): ?>
                                <tr role="row">
                                    ...
                                    <td class="col-sm-2">
                                        <?php echo anchor($base_path . 'news/setup/'.$row->id, '変更', array('class' => 'btn bg-orange btn-flat btn-sm')); ?>
...
<div class="modal fade" id="confirm-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <?php echo form_open($base_path . 'news/delete', array('method' => 'post'));?>
