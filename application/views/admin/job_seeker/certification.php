        ...
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <?php echo form_open(); ?>
                    ...
                    <div class="box-body">
                        <p><a href="#" id="form-modal-add" class="btn btn-success btn-flat">免許・資格登録</a></p>
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                <?php if(count($certification)): ?>
                                    <?php foreach ($certification as $certificate => $row): ?>
                                        <tr>
                                            <td><?php echo $row->from_year; ?></td>
                                            <td><?php echo $row->from_month; ?></td>
                                            <td><?php echo $row->description; ?></td></td>
                                            <td class="col-sm-2">
                                                <a href="#" class='form-modal-edit btn bg-orange btn-flat btn-sm' rel="<?php echo $certificate; ?>">更新</a>
        ...
        <div class="modal-content">
            <?php echo form_open('', array('class' => 'form-horizontal'));?>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2">免許・資格</label>
                        <div class="col-sm-9">
...
<div class="modal fade" id="confirm-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <?php echo form_open($base_path.'job_seeker/delete_certification/'.$job_seeker_id); ?>
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
              ...
              <?php echo form_hidden(array('id' => 0, 'confirm' => 'yes', 'name' => 'su')); ?>
            <?php echo form_close(); ?>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    $(function() {
         AjaxFormModal.init('<?php echo base_url($base_path.'job_seeker/add_certification/'.$job_seeker_id); ?>');
        AjaxFormModal.data = <?php echo json_encode($certification, true); ?>;
