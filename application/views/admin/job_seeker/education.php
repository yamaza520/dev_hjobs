        ...
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <?php echo form_open(); ?>
                    ...
                    <div class="box-body">
                        <p><a href="#" id="form-modal-add" class="btn btn-success btn-flat">学歴登録</a></p>
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                <?php if (count($education)) : ?>
                                    <?php foreach ($education as $index => $row): ?>
                                        <tr role="row">
                                ...
                                <?php else: ?>
                                <tr role="row">
                                    <td colspan="5" class="text-center">該当する学歴がありません。</td>
                                </tr>
                                <?php endif ?>
                            </tbody>
                        </table>
...
<div class="modal fade" id="confirm-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <?php echo form_open($base_path.'job_seeker/delete_education/'.$job_seeker_id); ?>
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
...
<script type="text/javascript">
    $(function() {
         AjaxFormModal.init('<?php echo base_url($base_path.'job_seeker/add_education/'.$job_seeker_id); ?>');
        AjaxFormModal.data = <?php echo json_encode($education, true); ?>;
