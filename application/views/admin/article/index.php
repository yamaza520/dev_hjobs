        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <?php echo anchor($base_path . 'article/setup', 'コラム登録', array('class' => 'btn btn-success btn-flat')); ?>
                </div>
                <div class="box-body">
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <?php if (count($result)): ?>
                            <?php foreach ($result as $row): ?>
                                <tr role="row">
                                    ...
                                    <td>
                                        <?php echo anchor($base_path . 'article/setup/'.$row->id, '変更', array('class' => 'btn bg-orange btn-flat btn-sm')); ?>
                        ...
                        <?php else: ?>
                            <tr role="row">
                                <td colspan="4" class="text-center">結果はありません。</td>
                            </tr>
                        <?php endif ?>
                        </tbody>
                    </table>
...
<div class="modal fade" id="confirm-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <?php echo form_open($base_path . 'article/delete', array('method' => 'post'));?>
