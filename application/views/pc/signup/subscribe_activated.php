<div id="contents" class="signup ezine">
    <div class="inner">
        ...
        <div class="form_tbl sec_in">
            <div class="thanks">
                ...
                <p class="memo">応募に必要な情報を入力し、本会員になりますと<br>「経歴情報の入力・編集」「履歴書・職務経歴書の作成」「チェックした求人への一括応募」<br>等が使用できます。</p>
            </div>
        </div><!--/#form_tbl-->
    </div>
</div><!--/#contents-->
