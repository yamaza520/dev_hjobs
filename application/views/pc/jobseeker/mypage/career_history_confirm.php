        ...
        <div id="main">
            ...
            <h2 class="tit mgn20">経歴情報の確認・編集</h2>
                <div class="sec_in form_tbl">
                    ...
                    <dl class="nobdr">
                        ...
                        <dd class="select_wrap">
                            <span class="input_text"><?php echo display_config_item($career_history['last_education_cd'], 'school_type'); ?></span><br>
                            ...
                            <span class="input_text"><?php echo display_config_item($career_history['graduate_cd'], 'degree_status'); ?></span><br>
                            <span class="left">文理区分</span>
                            <span class="input_text"><?php echo display_config_item($career_history['literature_type'], 'literature_type'); ?></span><br>
                ...
                <div class="sec_in form_tbl">
                    ...
                    <dl>
                        <dt>語学英語レベル<span class="must v2">推奨</span></dt>
                        <dd>
                    ...
                    <dl>
                        ...
                        <dd class="income">
                            <span class="input_text"><?php echo $career_history['toeic']; ?></span><span class="right">点</span>
                        </dd>
                    </dl>
                    <dl class="nobdr">
                ...
                <div class="btn_box2 cf">
                    <?php echo form_open();?>
                        ...
                        <div class="back_btn"><input type="button" value="編集画面に戻る" onclick="location.href='<?php echo site_url('mypage/career-history?edit=1'); ?>';"/></div>
                        <div class="resume_form_btn"><input type="submit" value="この内容で更新する" /></div>
                    <?php echo form_close(); ?>
                </div>
        </div><!--#main-->
