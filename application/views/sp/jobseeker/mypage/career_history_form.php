    ...
    <?php echo form_open('', array('method' => 'post'));?>
        ...
        <dl class="nobdr">
            ...
            <dd class="select_wrap">
                ...
                <br>
                <?php echo form_dropdown('graduate_cd', $degree_status, set_value('graduate_cd', $career_history['graduate_cd']), array('required' => 'required', 'class' => 'w60p mgnL')); ?>
                <br>
                <span class="left">文理区分</span>
                <?php echo form_dropdown('literature_type', $literature_type, set_value('literature_type', $career_history['literature_type']), array('required' => 'required', 'class' => 'w60p')); ?>
                <br>
                <?php
        ...
        <dl>
            ...
            <dd class="check">
                <ul class="cf">
                    <li>
                        <input type="radio" name="is_working" value="0" <?php echo set_radio('is_working', 0, (int) $career_history['is_working'] === 0 ? true : false);?> required/>
                        <label>就業中</label>
                    </li>
                    <li>
                        <input type="radio" name="is_working" value="1" <?php echo set_radio('is_working', 1, (int) $career_history['is_working'] === 1 ? true : false);?> required/>
                        <label>離職中</label>
                    </li>
                </ul>
            </dd>
        ...
        <div class="career_box">
            ...
            <?php if (!empty($career_history['working_history'])): ?>
                <?php foreach($career_history['working_history'] as $work_i => $work): ?>
                    <div id="working_<?php echo $work_i; ?>" class="resume_tbl">
                        ...
                        <dl>
                            ...
                            <dd class="check num mgn10">
                                <ul class="cf mgn10">
                                    <li>
                                        <input type="radio" name="management_exp[<?php echo $work_i; ?>]" value="1" <?php echo set_radio('management_exp['. $work_i. ']', 1, (int) $work['management_exp'] === 1 ? true : false);?>/>
                                        <label>あり</label>
                                    </li>
                                    <li>
                                        <input type="radio" name="management_exp[<?php echo $work_i; ?>]" value="0" <?php echo set_radio('management_exp['. $work_i. ']', 0, (int) $work['management_exp'] === 0 ? true : false);?>/>
                                        <label>なし</label>
                                    </li>
                                </ul>
                                <span class="left">（&emsp;マネジメントした人数&emsp;</span>
                                <?php
                                    echo form_input(array(
                                        'type'  => 'text',
                                ...
                                ?>
                                <span class="right">&emsp;人&emsp;）</span>
                            </dd>
                        </dl>
                        <dl>
                            ...
                            <dd class="job_cat">
                                ...
                                <div>
                                    ...
                                    <?php echo form_dropdown('industory_m_id['. $work_i. ']', $industory_m, set_value('industory_m_id['. $work_i. ']', $work['industory_m_id']), array('required' => 'required', 'id' => 'industory_m_id_'. $work_i)); ?>
                                </div>
                            </dd>
                        </dl>
                        <dl>
                        ...
                        <div class="ta_r"><a href="javascript:void(0)" class="delete_btn right" name='work_del[<?php echo $work_i;?>]'>削除 × </a></div>
                    </div>
                <?php endforeach ?>
            <?php endif ?>
        </div>
        <!--/.career_box-->
        <a href="#" class="add_btn">追加する</a>
        ...
        <div class="form_btn">
            <input type="submit" value="登録内容の確認へ" />
...
work_data = <?php echo json_encode($career_history['working_history']); ?>;
    ...
    $('.add_btn').on('click', function (e) {
        ...
        work_i = work_i  + 1;
        var html_string = '<div id="working_' + work_i + '" class="resume_tbl">';
        ...
        html_string += '<input type="hidden" name="work_id[' + work_i + ']" value=0>';
        ...
        html_string += '</dd> </dl> <dl> <dt>マネジメント経験<span class="must v2">推奨</span></dt> <dd class="num"> <label>';
