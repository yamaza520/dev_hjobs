    ...
    <div class="form_tbl sec_in">
        <?php echo form_open('', array('method' => 'post'));?>
            ...
            <dl>
                ...
                <dd class="check">
                    <ul class="cf">
                        <li><input type="radio" name="gender" value="f" <?php echo set_radio('gender', 'f', $jobseeker['gender'] == 'f' ? true : false);?> required/><label>女性</label></li>
                        <li><input type="radio" name="gender" value="m" <?php echo set_radio('gender', 'm', $jobseeker['gender'] == 'm' ? true : false);?> required/><label>男性</label></li>
                    </ul>
                </dd>
            </dl>
            <dl>
            ...
            <dl>
                ...
                <dd class="check">
                    <ul class="cf">
                        <li><input type="radio" name="is_working" value="0" <?php echo set_radio('is_working', 0, $jobseeker['is_working'] === 0 ? true : false);?> required/><label>就業中</label></li>
                        <li><input type="radio" name="is_working" value="1" <?php echo set_radio('is_working', 1, $jobseeker['is_working'] === 1 ? true : false);?> required/><label>離職中</label></li>
                    </ul>
                </dd>
            </dl>
            <dl>
                ...
                <dd class="check">
                    <ul class="cf">
                        <li><input type="radio" name="marital_status" value="m" <?php echo set_radio('marital_status', 'm', $jobseeker['marital_status'] == 'm' ? true : false);?> required/><label>既婚</label></li>
                        <li><input type="radio" name="marital_status" value="s" <?php echo set_radio('marital_status', 's', $jobseeker['marital_status'] == 's' ? true : false);?> required/><label>未婚</label></li>
                    </ul>
                </dd>
            </dl>
